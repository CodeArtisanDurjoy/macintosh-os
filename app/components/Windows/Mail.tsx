        ...
        <div className="flex flex-col text-sm">
            <div className="flex items-center gap-2 border-b border-foreground/30 pb-1">
                ...
                <span className={clsx(
                    ...
                    mdfoysal.cysec@gmail.com <LucideChevronDown size={15} />
                </span>
            </div>
            ...
            <div className="absolute bottom-4 right-4 z-10">
                <button
                    className={`h-14 w-14 border-[5px] border-background rounded-full grid place-items-center transition-all duration-300 ${canSend

        ...
        <div className="p-2">
            <div className="flex items-center gap-2">
                ...
                <div className="grid gap-1">
                    <h3 className={clsx(righteous.className, "text-2xl font-medium")}>Md Foysal</h3>
            ...
            <div className="flex items-center gap-1 my-5">
                ...
                <Link href="https://github.com/mdfoysalcysec/macintosh-os" target="_blank" rel="noopener noreferrer" title="Star this repo" className="bg-background shadow-[0px_5px_25px_rgba(0,0,0,0.05)] flex items-center justify-center px-5 py-3 text-sm rounded-full w-fit cursor-pointer hover:border-foreground/20 border border-foreground/5 active:scale-95 transition-all duration-300 active:opacity-75">
                    <Github size={20} />

...
export default function MobileViewNotice() {
    ...
    return (
        <div className="min-[767px]:hidden min-h-[100dvh] flex flex-col">
            ...
            >
                <Link href="https://mdfoysalcysec.online" target="_self" rel="noopener noreferrer" className="m-5 h-10 w-10 rounded-full grid place-items-center shadow-[0px_0px_5px] shadow-foreground/25 text-white bg-gradient-to-b from-blue-500 via-blue-600 to-blue-700">
            ...
            <motion.div className="px-5">
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-white">mdfoysalcysec.online</span>
                    </div>
            ...
            >© {new Date().getFullYear()} Md Foysal. All rights reserved.</motion.p>
        </div>
    )
}
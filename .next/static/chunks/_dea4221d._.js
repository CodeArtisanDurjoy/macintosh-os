...
"[project]/app/components/Windows/BezierClipPath.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const BezierClipPath = ()=>{
    ...
    const [dragCooldown, setDragCooldown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [isSpacePressed, setIsSpacePressed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isShiftPressed, setIsShiftPressed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [lockedAngle, setLockedAngle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [snapEnabled, setSnapEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [cursorMode, setCursorMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('pan');
    ...
    const [dragStartState, setDragStartState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [suggestionNode, setSuggestionNode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const saveToHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[saveToHistory]": (newPoints)=>{
            if (!Array.isArray(newPoints)) return;
            setHistory({
                "BezierClipPath.useCallback[saveToHistory]": (prev)=>{
                    const newHistory = prev.slice(0, historyIndex + 1);
                    newHistory.push(JSON.parse(JSON.stringify(newPoints)));
                    if (newHistory.length > maxHistorySteps) {
                        newHistory.shift();
                        setHistoryIndex({
                            "BezierClipPath.useCallback[saveToHistory]": (current)=>current - 1
                        }["BezierClipPath.useCallback[saveToHistory]"]);
                        return newHistory;
                    }
                    return newHistory;
                }
            ...
            setHistoryIndex({
                "BezierClipPath.useCallback[saveToHistory]": (prev)=>Math.min(prev + 1, maxHistorySteps - 1)
            }["BezierClipPath.useCallback[saveToHistory]"]);
        }
    }["BezierClipPath.useCallback[saveToHistory]"], [
        historyIndex,
    ...
    const undo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[undo]": ()=>{
            if (historyIndex > 0) {
                ...
                if (Array.isArray(previousState)) {
                    ...
                    setHistoryIndex({
                        "BezierClipPath.useCallback[undo]": (prev)=>prev - 1
                    }["BezierClipPath.useCallback[undo]"]);
                }
            }
        }
    ...
    const redo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[redo]": ()=>{
            if (historyIndex < history.length - 1) {
                ...
                if (Array.isArray(nextState)) {
                    ...
                    setHistoryIndex({
                        "BezierClipPath.useCallback[redo]": (prev)=>prev + 1
                    }["BezierClipPath.useCallback[redo]"]);
                }
            }
        }
    ...
    const getSnapSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[getSnapSuggestions]": function(x, y) {
            let isControlPoint = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, anchorPoint = arguments.length > 3 ? arguments[3] : void 0;
    ...
    }["BezierClipPath.useCallback[getSnapSuggestions]"], [
        snapEnabled,
        points
    ]);
    const getCanvasCoordinates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[getCanvasCoordinates]": function(clientX, clientY) {
            let applySuggestions = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true, isControlPoint = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, anchorPoint = arguments.length > 4 ? arguments[4] : void 0;
    ...
    }["BezierClipPath.useCallback[getCanvasCoordinates]"], [
        getSnapSuggestions
    ]);
    const findClosestPointOnPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[findClosestPointOnPath]": (x, y, segmentIndex)=>{
    ...
    }["BezierClipPath.useCallback[findClosestPointOnPath]"], [
        points
    ]);
    const getElementUnderCursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[getElementUnderCursor]": (clientX, clientY)=>{
            if (!canvasRef.current) return {
                type: 'none'
            };
            const rect = canvasRef.current.getBoundingClientRect();
    ...
    }["BezierClipPath.useCallback[getElementUnderCursor]"], [
        points
    ]);
    const handleMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleMouseDown]": (e, pointIndex, handleType)=>{
            e.preventDefault();
            e.stopPropagation();
            setHasDragged(false);
    ...
    }["BezierClipPath.useCallback[handleMouseDown]"], [
    ...
    const handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleMouseMove]": (e)=>{
            ...
            const updatePointPosition = {
                "BezierClipPath.useCallback[handleMouseMove].updatePointPosition": (pointIndex, x, y)=>{
                    setPoints({
                        "BezierClipPath.useCallback[handleMouseMove].updatePointPosition": (prev)=>{
                            const newPoints = [
                                ...prev
                            ];
                    ...
                    }["BezierClipPath.useCallback[handleMouseMove].updatePointPosition"]);
                }
            }["BezierClipPath.useCallback[handleMouseMove].updatePointPosition"];
            const actualX = coords.x - startX;
            updatePointPosition(pointIndex, actualX, coords.y - startY);
        }
    }["BezierClipPath.useCallback[handleMouseMove]"], [
        dragState,
        getCanvasCoordinates,
        points
    ]);
    const handleMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleMouseUp]": ()=>{
            if (dragState.isDragging && dragStartState && Array.isArray(dragStartState)) {
                ...
                if (!hasDragged && dragState.handleType === 'point') {
                    setSelectedPoint({
                        "BezierClipPath.useCallback[handleMouseUp]": (prev)=>prev === dragState.pointIndex ? null : dragState.pointIndex
                    }["BezierClipPath.useCallback[handleMouseUp]"]);
                }
                ...
                if (hasDragged) {
                    ...
                    setTimeout({
                        "BezierClipPath.useCallback[handleMouseUp]": ()=>setDragCooldown(false)
                    }["BezierClipPath.useCallback[handleMouseUp]"], 300); // 300ms cooldown
                }
            }
            setDragState({
                "BezierClipPath.useCallback[handleMouseUp]": (prev)=>({
                        ...prev,
                        isDragging: false
                    })
            }["BezierClipPath.useCallback[handleMouseUp]"]);
    ...
    const handleCanvasMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleCanvasMouseDown]": (e)=>{
    ...
    }["BezierClipPath.useCallback[handleCanvasMouseDown]"], [
    ...
    const handleCanvasMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleCanvasMouseMove]": (e)=>{
            if (dragState.isDragging) {
                ...
                if (isSpacePressed) {
                    ...
                    if (suggestionNode) {
                        setSuggestionNode({
                            "BezierClipPath.useCallback[handleCanvasMouseMove]": (prev)=>prev ? {
                                    ...prev,
                                    opacity: 0
                                } : null
                        }["BezierClipPath.useCallback[handleCanvasMouseMove]"]);
                        setTimeout({
                            "BezierClipPath.useCallback[handleCanvasMouseMove]": ()=>setSuggestionNode(null)
                        }["BezierClipPath.useCallback[handleCanvasMouseMove]"], 200);
                    }
                }
            }
        }
    ...
    const handleCanvasClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleCanvasClick]": (e)=>{
            ...
            if (element.type === 'path' && element.index !== undefined) {
                ...
                setPoints({
                    "BezierClipPath.useCallback[handleCanvasClick]": (prev)=>{
                        const newPoints = [
                            ...prev
                        ];
                        newPoints.splice(insertIndex, 0, newPoint);
                        setTimeout({
                            "BezierClipPath.useCallback[handleCanvasClick]": ()=>saveToHistory(newPoints)
                        }["BezierClipPath.useCallback[handleCanvasClick]"], 0);
                        return newPoints;
                    }
                }["BezierClipPath.useCallback[handleCanvasClick]"]);
            }
        }
    }["BezierClipPath.useCallback[handleCanvasClick]"], [
        dragState.isDragging,
    ...
    const handleCanvasMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[handleCanvasMouseUp]": ()=>{
            setIsPanning(false);
            handleMouseUp();
        }
    }["BezierClipPath.useCallback[handleCanvasMouseUp]"], [
    ...
    const generateSVGPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[generateSVGPath]": ()=>{
            if (points.length === 0) return '';
            let path = "M ".concat(points[0].x * 100, " ").concat(points[0].y * 100);
            for(let i = 1; i < points.length; i++){
                ...
                path += " C ".concat(cp1x, " ").concat(cp1y, ", ").concat(cp2x, " ").concat(cp2y, ", ").concat(currentPoint.x * 100, " ").concat(currentPoint.y * 100);
            }
            ...
            path += " C ".concat(cp1x, " ").concat(cp1y, ", ").concat(cp2x, " ").concat(cp2y, ", ").concat(firstPoint.x * 100, " ").concat(firstPoint.y * 100, " Z");
            return path;
        }
    }["BezierClipPath.useCallback[generateSVGPath]"], [
        points
    ]);
    const generateClipPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[generateClipPath]": ()=>{
            const path = generateSVGPath();
            return "clip-path: path('".concat(path, "');");
        }
    }["BezierClipPath.useCallback[generateClipPath]"], [
        generateSVGPath
    ]);
    ...
    const drawGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[drawGrid]": (ctx, width, height)=>{
            if (!showGrid) return;
    ...
    }["BezierClipPath.useCallback[drawGrid]"], [
        showGrid,
        snapGuides
    ]);
    const drawBezierPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[drawBezierPath]": (ctx, width, height)=>{
            if (points.length === 0) return;
            ctx.save();
            // Draw filled shape
    ...
    }["BezierClipPath.useCallback[drawBezierPath]"], [
        points
    ]);
    const drawControls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[drawControls]": (ctx, width, height)=>{
            ctx.save();
            ...
            if (suggestionNode) {
                ...
                // Outer pulse ring
                ctx.fillStyle = "rgba(34, 197, 94, ".concat(0.2 * opacity * pulseScale, ")");
                ctx.beginPath();
                ctx.arc(suggestionNode.x * width, suggestionNode.y * height, 16 * pulseScale, 0, 2 * Math.PI);
                ctx.fill();
                // Main suggestion node
                ctx.fillStyle = "rgba(34, 197, 94, ".concat(0.8 * opacity, ")");
            ...
            points.forEach({
                "BezierClipPath.useCallback[drawControls]": (point, index)=>{
                    // Draw control lines
                    ...
                    ctx.font = "bold ".concat(isHovered ? '12px' : '10px', " Inter, system-ui, sans-serif");
                    ctx.textAlign = 'center';
                    ctx.textBaseline = 'middle';
                    ctx.fillText(index.toString(), point.x * width, point.y * height);
                }
            }["BezierClipPath.useCallback[drawControls]"]);
            ctx.restore();
        }
    }["BezierClipPath.useCallback[drawControls]"], [
        points,
    ...
    const drawCanvas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BezierClipPath.useCallback[drawCanvas]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BezierClipPath.useEffect": ()=>{
            const handleKeyDown = {
                "BezierClipPath.useEffect.handleKeyDown": (e)=>{
                    if (e.code === 'Space') {
                        e.preventDefault();
                    ...
                    if (e.key === 'g' || e.key === 'G') {
                        e.preventDefault();
                        setShowGrid({
                            "BezierClipPath.useEffect.handleKeyDown": (prev)=>!prev
                        }["BezierClipPath.useEffect.handleKeyDown"]);
                    }
                }
            }["BezierClipPath.useEffect.handleKeyDown"];
            const handleKeyUp = {
                "BezierClipPath.useEffect.handleKeyUp": (e)=>{
                    if (e.code === 'Space') {
                        e.preventDefault();
            ...
            }["BezierClipPath.useEffect.handleKeyUp"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BezierClipPath.useEffect": ()=>{
            const animate = {
                "BezierClipPath.useEffect.animate": ()=>{
                    if (suggestionNode) {
                        drawCanvas();
                    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "absolute top-6 right-6 z-10 p-3 rounded-xl shadow-lg border transition-all duration-200 ".concat(copied ? 'bg-green-500 text-white border-green-500' : 'bg-white/90 backdrop-blur-sm text-slate-700 border-slate-200 hover:bg-white hover:shadow-xl'),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "absolute top-6 left-6 z-10 p-3 rounded-xl shadow-lg border transition-all duration-200 ".concat(showGrid ? 'bg-blue-500 text-white border-blue-500' : 'bg-white/90 backdrop-blur-sm text-slate-700 border-slate-200 hover:bg-white hover:shadow-xl'),
                title: "Toggle grid (G)",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "absolute top-20 left-6 z-10 p-3 rounded-xl shadow-lg border transition-all duration-200 ".concat(snapEnabled ? 'bg-purple-500 text-white border-purple-500' : 'bg-white/90 backdrop-blur-sm text-slate-700 border-slate-200 hover:bg-white hover:shadow-xl'),
            ...
            (()=>{
                ...
                return displayPoint !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "absolute z-20 backdrop-blur-sm rounded-xl shadow-xl border p-3 pointer-events-auto ".concat(selectedPoint !== null ? 'bg-blue-50/95 border-blue-200' : 'bg-white/95 border-slate-200'),
                    style: {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-3 h-3 rounded-full ".concat(points[displayPoint].type === 'corner' ? 'bg-red-500' : points[displayPoint].type === 'symmetric' ? 'bg-green-500' : 'bg-yellow-500')
                                }, void 0, false, {
                                    fileName: "[project]/app/components/Windows/BezierClipPath.tsx",
                                    lineNumber: 1130,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-sm font-medium ".concat(selectedPoint !== null ? 'text-blue-700' : 'text-slate-700'),
                                    children: [
                                        "Point ",
                                        displayPoint,
                                        " ",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                points.length > 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    showTips && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BezierClipPath, "+Np8zcjDvES4TNyXspxh89MpTUU=");
_c = BezierClipPath;
const __TURBOPACK__default__export__ = BezierClipPath;
var _c;
__turbopack_context__.k.register(_c, "BezierClipPath");
...
//# sourceMappingURL=_dea4221d._.js.map
...
"[project]/node_modules/lucide-react/dist/esm/icons/maximize-2.js [app-client] (ecmascript) <export default as LucideMaximize2>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/minus.js [app-client] (ecmascript) <export default as LucideMinus>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/x.js [app-client] (ecmascript) <export default as LucideX>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@useverse/usesoundeffect/dist/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
var useSoundEffect = function(soundUrl) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const { volume: initialVolume = 1, preload = true, loop = false, playRandomly = false, minInterval = 5e3, maxInterval = 15e3, autoplay = false } = options;
    ...
    const [currentVolume, setCurrentVolume] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialVolume);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSoundEffect.useEffect": ()=>{
    ...
    const startRandomPlayback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSoundEffect.useCallback[startRandomPlayback]": ()=>{
            if (intervalRef.current) {
                clearInterval(intervalRef.current);
                intervalRef.current = null;
            }
            const scheduleNextPlay = {
                "useSoundEffect.useCallback[startRandomPlayback].scheduleNextPlay": ()=>{
                    ...
                    }["useSoundEffect.useCallback[startRandomPlayback].scheduleNextPlay"], randomDelay);
                }
            }["useSoundEffect.useCallback[startRandomPlayback].scheduleNextPlay"];
            intervalRef.current = scheduleNextPlay();
        }
    ...
    const playSoundEffect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSoundEffect.useCallback[playSoundEffect]": ()=>{
            if (audioRef.current) {
            ...
            setIsPlaying(true);
            audio.play().catch({
                "useSoundEffect.useCallback[playSoundEffect]": (error)=>{
    ...
    const stopSoundEffect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSoundEffect.useCallback[stopSoundEffect]": ()=>{
            if (audioRef.current) {
                audioRef.current.pause();
                audioRef.current.currentTime = 0;
                audioRef.current = null;
    ...
    const adjustVolume = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSoundEffect.useCallback[adjustVolume]": (newVolume)=>{
    ...
    }["useSoundEffect.useCallback[adjustVolume]"], []);
    return {
...
var index_default = useSoundEffect;
;
}),
...
"[project]/node_modules/lucide-react/dist/esm/icons/chevron-down.js [app-client] (ecmascript) <export default as LucideChevronDown>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/send.js [app-client] (ecmascript) <export default as LucideSend>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/annoyed.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Annoyed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("annoyed", __iconNode);
;
 //# sourceMappingURL=annoyed.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/annoyed.js [app-client] (ecmascript) <export default as AnnoyedIcon>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/play.js [app-client] (ecmascript) <export default as LucidePlay>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/square.js [app-client] (ecmascript) <export default as LucideSquare>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/activity.js [app-client] (ecmascript) <export default as LucideActivity>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/terminal.js [app-client] (ecmascript) <export default as LucideTerminal>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/mail.js [app-client] (ecmascript) <export default as LucideMail>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/wifi-low.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const WifiLow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("wifi-low", __iconNode);
;
 //# sourceMappingURL=wifi-low.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/wifi-low.js [app-client] (ecmascript) <export default as WifiLow>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_bf8394b0._.js.map